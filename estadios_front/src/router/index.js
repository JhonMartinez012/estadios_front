...
const routes = [
  ...
  },
  {
    ...
    component: () => import(/* webpackChunkName: "about" */ '../views/Administradores/AdministradoresCrear.vue')
  },
  {
    path: '/administradores/ver',
    name: 'AdministradorVer',
    
    component: () => import(/* webpackChunkName: "about" */ '../views/Administradores/AdministradorVer.vue')
  },
  {
    path: '/administradores/id/editar/',
    name: 'AdministradorEditar',
    
    component: () => import(/* webpackChunkName: "about" */ '../views/Administradores/AdministradorUpdate.vue')
  },
  
  {
    path: '/Configuraciones',
    name: 'Configuraciones',
    component: () => import(/* webpackChunkName: "about" */ '../views/Configuraciones/Configuraciones.vue'),
    redirect: ({name : 'ConfiguracionTerrenos'}),
    children:[
      {
        path:'/Configuraciones',
        name:'ConfiguracionTerrenos',
        component:() => import('../views/Configuraciones/componentes/configuracionesTerreno.vue')
      },
      {
        path:'/Configuraciones',
        name:'ConfiguracionInactividad',
        component:() => import('../views/Configuraciones/componentes/configuracionesInactividad.vue')
      }
    ]
  }
